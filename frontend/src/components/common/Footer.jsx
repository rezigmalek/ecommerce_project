              ...
              <div className='container'>
                <div className='row mb-4'>
                  <div className='col-md-3 pb-4'>
                    ...
                    <div className='pt-3 pe-5'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aperiam hic dolores officia non optio, quas </div>
                  </div>
                  ...
                  <div className='col-md-3'>
                    ...
                    <ul>
                      <li>
                        <a href="#">+213 552836252</a>
                      </li>
                      <li>
                        <a href="#">dzmalek160@gmail.com</a>
                      </li>
                    </ul>
                  </div>
                </div>
                <div className='row spotlight py-4'>
                  ...
                  <div className='col-md-4'>
                    <div className='d-flex justify-content-center'>
                      ...
                      <h3 className='ps-2'>Secure Payement</h3>
                    </div>
                  </div>
                </div>
                <div className="row footer-bottom">
                  <div className='col-md-12 text-center pt-3'>
                    <p className='mb-8'>© 2025 All rights reserved | made by Rezig Abdel Malek</p>
                </div>
                </div>
            </div>
          </footer>
